"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[762], {
    10538: function (t, e, r) {
         ...
         */ var s = r(70079), n = "function" == typeof Object.is ? Object.is : function (t, e) {
        ...
        var s = r(49043), n = r(42422), i = r(31406), u = r(94521), o = r(99695);
        ...
        class c extends u.l {
            ...
            createResult(t, e) {
                let r = this.currentQuery, n = this.options, i = this.currentResult, u = this.currentResultState,
                    c = this.currentResultOptions, a = t !== r, f = a ? t.state : this.currentQueryInitialState,
                    p = a ? this.currentResult : this.previousQueryResult, {state: y} = t, {
                        dataUpdatedAt: v,
                        error: R,
                        errorUpdatedAt: S,
                        fetchStatus: b,
                ...
                if (e._optimisticResults) {
                    let I = this.hasListeners(), C = !I && l(t, e), O = I && h(t, r, e, n);
                    (C || O) && (b = (0, o.Kw)(t.options.networkMode) ? "fetching" : "paused", v || (m = "loading")), "isRestoring" === e._optimisticResults && (b = "idle")
                }
                if (e.keepPreviousData && !y.dataUpdatedAt && null != p && p.isSuccess && "error" !== m) g = p.data, v = p.dataUpdatedAt, m = p.status, E = !0; else if (e.select && void 0 !== y.data) {
                    if (i && y.data === (null == u ? void 0 : u.data) && e.select === this.selectFn) g = this.selectResult; else try {
                ...
                if (void 0 !== e.placeholderData && void 0 === g && "loading" === m) {
                    let w;
                    if (null != i && i.isPlaceholderData && e.placeholderData === (null == c ? void 0 : c.placeholderData)) w = i.data; else if (w = "function" == typeof e.placeholderData ? e.placeholderData() : e.placeholderData, e.select && void 0 !== w) try {
                ...
                let U = "fetching" === b, k = "loading" === m, x = "error" === m, P = {
                    status: m,
                    fetchStatus: b,
                    isLoading: k,
                    isSuccess: "success" === m,
        ...
        var s = r(70079), n = r(39858), i = r(42422), u = r(404), o = r(62906), c = r(17866), l = r(60112),
            a = r(86857);
        ...
        var s = r(49043), n = r(89335), i = r(52696);
