    ...
    75927: function (e, t, r) {
        ...
        class i {
            constructor(e, t) {
                ...
                var r = "KaTeX parse error: " + e, a = t && t.loc;
                if (a && a.start <= a.end) {
        ...
        var s = function (e, t) {
            ...
            p = function e(t) {
                ...
                contains: s, deflt: o, escape: function (e) {
                    return String(e).replace(c, e => m[e])
                }, hyphenate: h, getBaseElem: p, isCharacterBox: u, protocolFromUrl: g
            }, v = {
                displayMode: {
                    type: "boolean",
        ...
        class y {
            constructor(e) {
                for (var t in this.displayMode = void 0, this.output = void 0, this.leqno = void 0, this.fleqn = void 0, this.throwOnError = void 0, this.errorColor = void 0, this.macros = void 0, this.minRuleThickness = void 0, this.colorIsTextColor = void 0, this.strict = void 0, this.trust = void 0, this.maxSize = void 0, this.maxExpand = void 0, this.globalGroup = void 0, e = e || {}, v) if (v.hasOwnProperty(t)) {
                    var r = v[t];
        ...
        var w = [new x(0, 0, !1), new x(1, 0, !0), new x(2, 1, !1), new x(3, 1, !0), new x(4, 2, !1), new x(5, 2, !0), new x(6, 3, !1), new x(7, 3, !0)],
            k = [4, 5, 4, 5, 6, 7, 6, 7], S = [5, 5, 5, 5, 7, 7, 7, 7], M = [2, 3, 4, 5, 6, 7, 6, 7],
            z = [3, 3, 5, 5, 7, 7, 7, 7], A = [1, 1, 3, 3, 5, 5, 7, 7], T = [0, 1, 2, 3, 2, 3, 2, 3],
            B = {DISPLAY: w[0], TEXT: w[2], SCRIPT: w[4], SCRIPTSCRIPT: w[6]},
            q = [{name: "latin", blocks: [[256, 591], [768, 879]]}, {
                name: "cyrillic",
                blocks: [[1024, 1279]]
        ...
        function N(e) {
            for (var t = 0; t < C.length; t += 2) if (e >= C[t] && e <= C[t + 1]) return !0;
            return !1
        }
        ...
        var V = {},
            G = [[1, 1, 1], [2, 1, 1], [3, 1, 1], [4, 2, 1], [5, 2, 1], [6, 3, 1], [7, 4, 2], [8, 6, 3], [9, 7, 6], [10, 8, 7], [11, 10, 9]],
            U = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], Y = function (e, t) {
        ...
        class X {
            ...
            havingStyle(e) {
                return this.style === e ? this : this.extend({style: e, size: Y(this.textSize, e)})
            }
            ...
            fontMetrics() {
                return this._fontMetrics || (this._fontMetrics = function (e) {
                    ...
                    if (!V[t = e >= 5 ? 0 : e >= 3 ? 1 : 2]) {
                        var r = V[t] = {cssEmPerMu: L.quad[t] / 18};
        ...
        var W = {
            ...
            sp: 1 / 65536,
            px: 1.00375
        }, _ = {ex: !0, em: !0, mu: !0}, j = function (e) {
            return "string" != typeof e && (e = e.unit), e in W || e in _ || "ex" === e
        }, $ = function (e, t) {
            var r, a;
            if (e.unit in W) r = W[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier; else if ("mu" === e.unit) r = t.fontMetrics().cssEmPerMu; else {
                if (a = t.style.isTight() ? t.havingStyle(t.style.text()) : t, "ex" === e.unit) r = a.fontMetrics().xHeight; else if ("em" === e.unit) r = a.fontMetrics().quad; else throw new i("Invalid unit: '" + e.unit + "'");
        ...
        var em = {bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1},
            ec = {"accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1}, ep = {math: {}, text: {}};

        function eu(e, t, r, a, n, i) {
            ep[e][n] = {font: t, group: r, replace: a}, i && a && (ep[e][a] = ep[e][n])
        }

        var ed = "math", eg = "text", ef = "main", ev = "accent-token", eb = "close", ey = "inner", ex = "mathord",
            ew = "op-token", ek = "open", eS = "punct", eM = "spacing", ez = "textord";
        ...
        var eY = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathnormal", "textit", "Math-Italic"], ["mathnormal", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            eX = [["mathbf", "textbf", "Main-Bold"], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathtt", "texttt", "Typewriter-Regular"]],
            eW = function (e, t) {
                ...
                return ep[r][e] && ep[r][e].replace && (e = ep[r][e].replace), {value: e, metrics: F(e, t, r)}
            }, ej = function (e, t, r, a, n) {
                var i, s = e_(e, t, r), o = s.metrics;
                if (e = s.value, o) {
                    var l = o.italic;
                ...
                var a = e.mode, n = e.text, i = ["mord"], s = "math" === a || "text" === a && t.font,
                ...
                return eQ(n), n
            }, e1 = (e, t, r, a) => new et(e, t, r, a), e4 = function (e, t, r) {
                var a = e0([e], [], t);
                ...
                if ("top" === e.positionType) {
                    ...
                    if ("shift" === e.positionType) t = -p.elem.depth - e.positionData; else if ("firstBaseline" === e.positionType) t = -p.elem.depth; else throw Error("Invalid positionType " + e.positionType + ".")
                }
                return {children: e.children, depth: t}
            }, e8 = function (e, t) {
                for (var r, {children: a, depth: n} = e3(e), i = 0, s = 0; s < a.length; s++) {
                    var o = a[s];
                    if ("elem" === o.type) {
                        var l = o.elem;
                ...
                for (var m = [], c = n, p = n, u = n, d = 0; d < a.length; d++) {
                    ...
                    if ("kern" === g.type) u += g.size; else {
                        var f, v = g.elem, b = e0(g.wrapperClasses || [], [h, v], void 0, g.wrapperStyle || {});
                ...
                svgData: tt,
                tryCombineChars: eJ
            }, tn = {number: 3, unit: "mu"}, ti = {number: 4, unit: "mu"}, ts = {number: 5, unit: "mu"}, to = {
                mord: {mop: tn, mbin: ti, mrel: ts, minner: tn},
                mop: {mord: tn, mop: tn, mrel: ts, minner: tn},
                mbin: {mord: ti, mop: ti, mopen: ti, minner: ti},
                mrel: {mord: ts, mop: ts, mopen: ts, minner: ts},
                mopen: {},
                mclose: {mop: tn, mbin: ti, mrel: ts, minner: tn},
                mpunct: {mord: tn, mop: tn, mrel: ts, mopen: tn, mclose: tn, mpunct: tn, minner: tn},
                minner: {mord: tn, mop: tn, mbin: ti, mrel: ts, mopen: tn, mpunct: tn, minner: tn}
            }, tl = {
                mord: {mop: tn},
                mop: {mord: tn, mop: tn},
                mbin: {},
        ...
        var td = function (e) {
            ...
            }, tf = ta.makeSpan, tv = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
            tb = ["rightmost", "mrel", "mclose", "mpunct"],
            ty = {display: B.DISPLAY, text: B.TEXT, script: B.SCRIPT, scriptscript: B.SCRIPTSCRIPT}, tx = {
                mord: "mord",
                mop: "mop",
                mbin: "mbin",
                mrel: "mrel",
                ...
                var m = tf([a[0] || "leftmost"], [], t), c = tf([a[1] || "rightmost"], [], t), p = "root" === r;
                return tk(n, (e, t) => {
                    var r = t.classes[0], a = e.classes[0];
                    "mbin" === r && f.contains(tb, a) ? t.classes[0] = "mord" : "mbin" === a && f.contains(tv, r) && (e.classes[0] = "mord")
                }, {node: m}, c, p), tk(n, (e, t) => {
                    var r = tz(t), a = tz(e), n = r && a ? e.hasClass("mtight") ? tl[r][a] : to[r][a] : null;
        ...
        function tq(e, t) {
            ...
            for (var s = [], o = [], l = 0; l < i.length; l++) if (o.push(i[l]), i[l].hasClass("mbin") || i[l].hasClass("mrel") || i[l].hasClass("allowbreak")) {
        ...
        var tR = {
            MathNode: tN, TextNode: tI, SpaceNode: class {
                constructor(e) {
            ...
            if ("mathfrak" === r) return "fraktur"; else if ("mathscr" === r || "mathcal" === r) return "script"; else if ("mathsf" === r) return "sans-serif"; else if ("mathtt" === r) return "monospace";
            var n = e.text;
        ...
        function tF(e, t, r, a, n) {
            ...
            var l = new tR.MathNode("semantics", [i, o]), h = new tR.MathNode("math", [l]);
        ...
        var tV = function (e) {
            ...
            if ("html" === r.output) {
                ...
                var s = tF(e, t, n, r.displayMode, !1), o = tq(e, n);
                a = ta.makeSpan(["katex"], [s, o])
            }
            return tG(a, r)
        }, tY = function (e, t, r) {
            var a = tV(r), n = tq(e, a), i = ta.makeSpan(["katex"], [n]);
            return tG(i, r)
        }, tX = {
            widehat: "^",
            widecheck: "ˇ",
            ...
            var {span: r, minWidth: a, height: n} = function () {
                var r, a = 4e5, n = e.label.substr(1);
                if (f.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                    var i, s, o, l, h = "ordgroup" === (l = e.base).type ? l.body.length : 1;
                    if (h > 5) "widehat" === n || "widecheck" === n ? (i = 420, a = 2364, o = .42, s = n + "4") : (i = 312, a = 2340, o = .34, s = "tilde4"); else {
                        var m = [1, 1, 2, 2, 3, 3][h];
                    ...
                    var c = new eo(s), p = new es([c], {
                        width: "100%",
                        height: Z(o),
                        viewBox: "0 0 " + a + " " + i,
                        preserveAspectRatio: "none"
                    });
                    return {span: ta.makeSvgSpan([], [p], t), minWidth: 0, height: o}
                }
                var u, d, g = [], v = t_[n], [b, y, x] = v, w = x / 1e3, k = b.length;
                if (1 === k) {
                    u = ["hide-tail"], d = [v[3]]
                } else if (2 === k) u = ["halfarrow-left", "halfarrow-right"], d = ["xMinYMin", "xMaxYMin"]; else if (3 === k) u = ["brace-left", "brace-center", "brace-right"], d = ["xMinYMin", "xMidYMin", "xMaxYMin"]; else throw Error("Correct katexImagesData or update code here to support\n                    " + k + " children.");
                for (var S = 0; S < k; S++) {
                    var M = new eo(b[S]), z = new es([M], {
                        width: "400em",
                        height: Z(w),
                        viewBox: "0 0 " + a + " " + x,
                        preserveAspectRatio: d[S] + " slice"
                    }), A = ta.makeSvgSpan([u[S]], [z], t);
                    if (1 === k) return {span: A, minWidth: y, height: w};
                    A.style.height = Z(w), g.push(A)
                }
                return {span: ta.makeSpan(["stretchy"], g, t), minWidth: y, height: w}
            }();
            ...
            if (/fbox|color|angl/.test(t)) {
                ...
                var h = new es(l, {width: "100%", height: Z(s)});
                i = ta.makeSvgSpan([], [h], n)
            }
            return i.height = s, i.style.height = Z(s), i
        }, tZ = {encloseSpan: t$, mathMLnode: tW, svgSpan: tj};
        ...
        var t0 = (e, t) => {
                ...
                var r = tT(h, t.havingCrampedStyle()), a = m.isShifty && f.isCharacterBox(h), n = 0;
                if (a) {
                    var i = f.getBaseElem(h), s = tT(i, t.havingCrampedStyle());
                    n = eh(s).skew
                }
                var o = "\\c" === m.label, l = o ? r.height + r.depth : Math.min(r.height, t.fontMetrics().xHeight);
                if (m.isStretchy) p = tZ.svgSpan(m, t), p = ta.makeVList({
                    ...
                    children: [{type: "elem", elem: r}, {
                        ...
                        wrapperStyle: n > 0 ? {width: "calc(100% - " + Z(2 * n) + ")", marginLeft: Z(2 * n)} : void 0
                    }]
                }, t); else {
                    ...
                    g || (v -= d / 2), p.style.left = Z(v), "\\textcircled" === m.label && (p.style.top = ".2em"), p = ta.makeVList({
                        positionType: "firstBaseline",
                        children: [{type: "elem", elem: r}, {type: "kern", size: -l}, {type: "elem", elem: p}]
                    }, t)
                }
        ...
        tp({
            ...
            props: {numArgs: 1},
            handler(e, t) {
                var r = td(t[0]), a = !t4.test(e.funcName),
            ...
            htmlBuilder(e, t) {
                var r = tT(e.base, t), a = tZ.svgSpan(e, t), n = "\\utilde" === e.label ? .12 : 0, i = ta.makeVList({
                    positionType: "top",
                    positionData: r.height,
                    children: [{type: "elem", elem: a, wrapperClasses: ["svg-align"]}, {
                        type: "kern",
                        size: n
                    }, {type: "elem", elem: r}]
                }, t);
            ...
            mathmlBuilder(e, t) {
                var r = tZ.mathMLnode(e.label), a = new tR.MathNode("munder", [tP(e.base, t), r]);
        ...
        tp({
            ...
            htmlBuilder(e, t) {
                var r, a, n = t.style, i = t.havingStyle(n.sup()), s = ta.wrapFragment(tT(e.body, i, t), t),
                ...
                var l = tZ.svgSpan(e, t), h = -t.fontMetrics().axisHeight + .5 * l.height,
                ...
                if ((s.depth > .25 || "\\xleftequilibrium" === e.label) && (m -= s.depth), r) {
                    ...
                    a = ta.makeVList({
                        ...
                        children: [{type: "elem", elem: s, shift: m}, {type: "elem", elem: l, shift: h}, {
                            type: "elem",
                            elem: r,
                            shift: c
                        }]
        ...
        var t6 = {
                ...
                "|": "\\Vert",
                ".": "no arrow"
            }, t7 = () => ({type: "styling", body: [], mode: "math", style: "display"}),
            ...
            switch (a) {
                ...
                case"\\downarrow":
                    var n = r.callFunction("\\\\cdleft", [t[0]], []),
                        i = r.callFunction("\\Big", [{type: "atom", text: a, mode: "math", family: "rel"}], []),
                        s = r.callFunction("\\\\cdright", [t[1]], []);
                    return r.callFunction("\\\\cdparent", [{type: "ordgroup", mode: "math", body: [n, i, s]}], []);
                case"\\\\cdlongequal":
        ...
        tp({
            type: "cdlabel", names: ["\\\\cdleft", "\\\\cdright"], props: {numArgs: 1}, handler(e, t) {
                ...
                var r = t.havingStyle(t.style.sup()), a = ta.wrapFragment(tT(e.label, r, t), t);
            ...
            type: "textord", names: ["\\@char"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                for (var r, {parser: a} = e, n = tK(t[0], "ordgroup").body, s = "", o = 0; o < n.length; o++) {
        ...
        var t9 = (e, t) => {
            ...
            var r = tL(e.body, t.withColor(e.color)), a = new tR.MathNode("mstyle", r);
        ...
        tp({
            ...
            handler(e, t) {
                var {parser: r} = e, a = tK(t[0], "color-token").color, n = t[1];
                return {type: "color", mode: r.mode, color: a, body: tg(n)}
            },
            htmlBuilder: t9,
            mathmlBuilder: re
        }), tp({
            ...
            handler(e, t) {
                var {parser: r, breakOnTokenText: a} = e, n = tK(t[0], "color-token").color;
        ...
        tp({
            ...
            handler(e) {
                ...
                for (var o = 0, l = [[]]; "{" !== r.gullet.future().text;) if ("#" === (n = r.gullet.popToken()).text) {
                    ...
                    o++, l.push([])
                } else if ("EOF" === n.text) throw new i("Expected a macro definition"); else l[o].push(n.text);
                ...
                return t && h.unshift(t), ("\\edef" === a || "\\xdef" === a) && (h = r.gullet.expandTokens(h)).reverse(), r.gullet.macros.set(s, {
                    ...
                    numArgs: o,
                    delimiters: l
                }, a === rt[a]), {type: "internal", mode: r.mode}
            }
        }), tp({
            type: "internal",
            names: ["\\let", "\\\\globallet"],
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler(e) {
                var {parser: t, funcName: r} = e, a = rr(t.gullet.popToken());
                t.gullet.consumeSpaces();
                var n = ra(t);
                return rn(t, a, n, "\\\\globallet" === r), {type: "internal", mode: t.mode}
            }
        }), tp({
            type: "internal",
            ...
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler(e) {
                var {parser: t, funcName: r} = e, a = rr(t.gullet.popToken()), n = t.gullet.popToken(),
                    i = t.gullet.popToken();
        ...
        var ri = function (e, t, r) {
                ...
                var n = r.havingBaseStyle(t), i = ta.makeSpan(a.concat(n.sizingClasses(r)), [e], r),
                    s = n.sizeMultiplier / r.sizeMultiplier;
                return i.height *= s, i.depth *= s, i.maxFontSize = n.sizeMultiplier, i
            }, ro = function (e, t, r) {
                var a = t.havingBaseStyle(r), n = (1 - t.sizeMultiplier / a.sizeMultiplier) * t.fontMetrics().axisHeight;
                e.classes.push("delimcenter"), e.style.top = Z(n), e.height -= n, e.depth += n
            }, rl = function (e, t, r, a, n, i) {
                var s = ta.makeSymbol(e, "Main-Regular", n, a), o = rs(s, t, a, i);
                return r && ro(o, a, t), o
                ...
                var a = E["Size4-Regular"][e.charCodeAt(0)] ? E["Size4-Regular"][e.charCodeAt(0)][4] : E["Size1-Regular"][e.charCodeAt(0)][4],
                    n = new eo("inner", R(e, Math.round(1e3 * t))), i = new es([n], {
                        width: Z(a),
                        height: Z(t),
                        style: "width:" + Z(a),
                ...
                return s.height = t, s.style.height = Z(t), s.style.width = Z(a), {type: "elem", elem: s}
            }, rp = {type: "kern", size: -.008}, ru = ["|", "\\lvert", "\\rvert", "\\vert"],
            rd = ["\\|", "\\lVert", "\\rVert", "\\Vert"], rg = function (e, t, r, a, n, i) {
                s = l = h = e, o = null;
                ...
                var c = ri(s, m, n), p = c.height + c.depth, u = ri(l, m, n), d = u.height + u.depth, g = ri(h, m, n),
                    v = g.height + g.depth, b = 0, y = 1;
                if (null !== o) {
                    var x = ri(o, m, n);
                    b = x.height + x.depth, y = 2
                }
                var w = p + v + b, k = Math.max(0, Math.ceil((t - w) / (y * d))), S = w + k * y * d,
                    M = a.fontMetrics().axisHeight;
                r && (M *= a.sizeMultiplier);
                var z = [];
                if (z.push(rm(h, m, n)), z.push(rp), null === o) z.push(rc(l, S - p - v + .016, a)); else {
                    var A = (S - p - v - b) / 2 + .016;
                ...
                var T = a.havingBaseStyle(B.TEXT),
                    q = ta.makeVList({positionType: "bottom", positionData: S / 2 - M, children: z}, T);
                return rs(ta.makeSpan(["delimsizing", "mult"], [q], T), B.TEXT, a, i)
            }, rf = function (e, t, r, a, n) {
                var i = I(e, a, r), s = new eo(e, i), o = new es([s], {
                    width: "400em",
                    height: Z(t),
                ...
                var r, a, n = t.havingBaseSizing(), i = rT("\\surd", e * n.sizeMultiplier, rz, n), s = n.sizeMultiplier,
                    o = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness), l = 0, h = 0, m = 0;
            ...
            rx = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], rw = [0, 1.2, 1.8, 2.4, 3],
            ...
            }, rS = [{type: "small", style: B.SCRIPTSCRIPT}, {type: "small", style: B.SCRIPT}, {
                type: "small",
                style: B.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            rM = [{type: "small", style: B.SCRIPTSCRIPT}, {type: "small", style: B.SCRIPT}, {
                type: "small",
                style: B.TEXT
            }, {type: "stack"}], rz = [{type: "small", style: B.SCRIPTSCRIPT}, {type: "small", style: B.SCRIPT}, {
                type: "small",
                style: B.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], rA = function (e) {
                ...
                for (var n = Math.min(2, 3 - a.style.size), i = n; i < r.length && "stack" !== r[i].type; i++) {
                    var s = ri(e, rA(r[i]), "math"), o = s.height + s.depth;
                ...
                var s = a.fontMetrics().axisHeight * a.sizeMultiplier, o = 5 / a.fontMetrics().ptPerEm,
                    l = Math.max(t - s, r + s);
                return rB(e, Math.max(l / 500 * 901, 2 * l - o), !0, a, n, i)
            }, rC = {sqrtImage: rv, sizedDelim: rk, sizeToMaxHeight: rw, customSizedDelim: rB, leftRightDelim: rq}, rN = {
        ...
        tp({
            ...
            type: "leftright", names: ["\\left"], props: {numArgs: 1, primitive: !0}, handler(e, t) {
                ...
                if (i *= t.sizeMultiplier, s *= t.sizeMultiplier, r = "." === e.left ? tA(t, ["mopen"]) : rC.leftRightDelim(e.left, i, s, t, e.mode, ["mopen"]), n.unshift(r), o) for (var h = 1; h < n.length; h++) {
                    var m = n[h].isMiddle;
                    m && (n[h] = rC.leftRightDelim(m.delim, i, s, m.options, e.mode, []))
                }
                if ("." === e.right) a = tA(t, ["mclose"]); else {
        ...
        var rH = (e, t) => {
            var r, a, n = ta.wrapFragment(tT(e.body, t), t), i = e.label.substr(1), s = t.sizeMultiplier, o = 0,
                l = f.isCharacterBox(e.body);
            if ("sout" === i) (r = ta.makeSpan(["stretchy", "sout"])).height = t.fontMetrics().defaultRuleThickness / s, o = -.5 * t.fontMetrics().xHeight; else if ("phase" === i) {
                var h = $({number: .6, unit: "pt"}, t), m = $({number: .35, unit: "ex"}, t);
            ...
            if (e.backgroundColor) a = ta.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: r, shift: o}, {type: "elem", elem: n, shift: 0}]
            }, t); else {
                var y = /cancel|phase/.test(i) ? ["svg-align"] : [];
                a = ta.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: n, shift: 0}, {type: "elem", elem: r, shift: o, wrapperClasses: y}]
                }, t)
            }
            ...
            var r = 0, a = new tR.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [tP(e.body, t)]);
            switch (e.label) {
                case"\\cancel":
        ...
        tp({
            ...
            handler(e, t, r) {
                var {parser: a, funcName: n} = e, i = tK(t[0], "color-token").color, s = t[1];
            ...
            handler(e, t, r) {
                var {parser: a, funcName: n} = e, i = tK(t[0], "color-token").color, s = tK(t[1], "color-token").color,
                    o = t[2];
                return {type: "enclose", mode: a.mode, label: n, backgroundColor: s, borderColor: i, body: o}
            },
            htmlBuilder: rH,
            mathmlBuilder: rE
        }), tp({
        ...
        function rY(e, t, r) {
            ...
            if (e.gullet.beginGroup(), c || e.gullet.macros.set("\\cr", "\\\\\\relax"), !l) {
                ...
                if (null == g) l = 1; else if (!(l = parseFloat(g)) || l < 0) throw new i("Invalid \\arraystretch: " + g)
            }
            e.gullet.beginGroup();
            var f = [], v = [f], b = [], y = [], x = null != m ? [] : void 0;
            ...
            for (w(), y.push(rV(e)); ;) {
                ...
                e.gullet.endGroup(), e.gullet.beginGroup(), S = {
                    ...
                    mode: e.mode,
                    body: S
                }, r && (S = {type: "styling", mode: e.mode, style: r, body: [S]}), f.push(S);
                var M = e.fetch().text;
                if ("&" === M) {
                    if (u && f.length === u) {
        ...
        var rW, r_, rj, r$, rZ = function (e, t) {
            var r, a, n, s, o = e.body.length, l = e.hLinesBeforeRow, h = 0, m = Array(o), c = [],
                p = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness), u = 1 / t.fontMetrics().ptPerEm,
                d = 5 * u;
            e.colSeparationType && "small" === e.colSeparationType && (d = .2778 * (t.havingStyle(B.SCRIPT).sizeMultiplier / t.sizeMultiplier));
            var g = "CD" === e.colSeparationType ? $({number: 3, unit: "ex"}, t) : 12 * u, v = 3 * u,
                b = e.arraystretch * g, y = .7 * b, x = .3 * b, w = 0;

            function k(e) {
                for (var t = 0; t < e.length; ++t) t > 0 && (w += .25), c.push({pos: w, isDashed: e[t]})
            }

            for (k(l[0]), r = 0; r < e.body.length; ++r) {
                var S = e.body[r], M = y, z = x;
            ...
            for (a = 0, s = 0; a < h || s < I.length; ++a, ++s) {
                ...
                if (!(a >= h)) {
                    ...
                    for (r = 0; r < o; ++r) {
                        ...
                        if (_) {
                            var j = W.pos - N;
                            _.depth = W.depth, _.height = W.height, X.push({type: "elem", elem: _, shift: j})
                        }
                    }
                    X = ta.makeVList({
                        positionType: "individualShift",
            ...
            if (m = ta.makeSpan(["mtable"], R), c.length > 0) {
                for (var K = ta.makeLineSpan("hline", t, p), J = ta.makeLineSpan("hdashline", t, p), Q = [{
                    ...
                    var ee = c.pop(), et = ee.pos - N;
                    ee.isDashed ? Q.push({type: "elem", elem: J, shift: et}) : Q.push({
                        type: "elem",
                        elem: K,
                        shift: et
                    })
                }
                m = ta.makeVList({positionType: "individualShift", children: Q}, t)
            }
            if (0 === O.length) return ta.makeSpan(["mord"], [m], t);
            var er = ta.makeVList({positionType: "individualShift", children: O}, t);
            return er = ta.makeSpan(["tag"], [er], t), ta.makeFragment([m, er])
        }, rK = {c: "center ", l: "left ", r: "right "}, rJ = function (e, t) {
            ...
            if (e.cols && e.cols.length > 0) {
                var u = e.cols, d = "", g = !1, f = 0, v = u.length;
            ...
            var r, a = [], n = e.envName.indexOf("at") > -1 ? "alignat" : "align", s = "split" === e.envName,
                o = rY(e.parser, {
                    cols: a,
                    addJot: !0,
            ...
            for (var d = 0; d < l; ++d) {
                var g = "r", f = 0;
                d % 2 == 1 ? g = "l" : d > 0 && u && (f = 1), a[d] = {type: "align", align: g, pregap: f, postgap: 0}
            }
        ...
        rD({
            ...
            }, htmlBuilder: rZ, mathmlBuilder: rJ
        }), rD({
            type: "array",
            ...
            handler(e) {
                ...
                var s = rY(e.parser, a, rX(e.envName)), o = Math.max(0, ...s.body.map(e => e.length));
                return s.cols = Array(o).fill({type: "align", align: r}), t ? {
                    type: "leftright",
                    mode: e.mode,
                    body: [s],
                    left: t[0],
            ...
            type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler(e) {
                var t = rY(e.parser, {arraystretch: .5}, "script");
            ...
            type: "array", names: ["CD"], props: {numArgs: 0}, handler: e => (rG(e), function (e) {
                var t = [];
                for (e.gullet.beginGroup(), e.gullet.macros.set("\\cr", "\\\\\\relax"), e.gullet.beginGroup(); ;) {
                    ...
                    var r = e.fetch().text;
                    if ("&" === r || "\\\\" === r) e.consume(); else if ("\\end" === r) {
                        0 === t[t.length - 1].length && t.pop();
                        break
                    } else throw new i("Expected \\\\ or \\cr or \\end", e.nextToken)
                }
                for (var a = [], n = [a], s = 0; s < t.length; s++) {
                    for (var o = t[s], l = t7(), h = 0; h < o.length; h++) if (t3(o[h])) {
                        a.push(l);
                        var m = tJ(o[h += 1]).text, c = [, ,];
                        if (c[0] = {type: "ordgroup", mode: "math", body: []}, c[1] = {
                            type: "ordgroup",
                            mode: "math",
                            body: []
                        }, "=|.".indexOf(m) > -1) ; else if ("<>AV".indexOf(m) > -1) for (var p = 0; p < 2; p++) {
                        ...
                        var g = {type: "styling", body: [t2(m, c, e)], mode: "math", style: "display"};
                        a.push(g), l = t7()
                    } else l.body.push(o[h]);
                    s % 2 == 0 ? a.push(l) : a.shift(), a = [], n.push(a)
                }
                e.gullet.endGroup(), e.gullet.endGroup();
                var f = Array(n[0].length).fill({type: "align", align: "c", pregap: .25, postgap: .25});
                return {
                    type: "array",
                    mode: "math",
                    body: n,
            ...
            }(e.parser)), htmlBuilder: rZ, mathmlBuilder: rJ
            ...
            handler(e, t) {
                ...
                if ("\\begin" === a) {
                    ...
                    var l = rL[s], {args: h, optArgs: m} = r.parseArguments("\\begin{" + s + "}", l),
                        c = {mode: r.mode, envName: s, parser: r}, p = l.handler(c, h, m);
                    r.expect("\\end", !1);
                    var u = r.nextToken, d = tK(r.parseFunction(), "environment");
        ...
        tp({
            ...
            type: "mclass", names: ["\\stackrel", "\\overset", "\\underset"], props: {numArgs: 2}, handler(e, t) {
                ...
                return {type: "mclass", mode: a.mode, mclass: r, body: [l], isCharacterBox: f.isCharacterBox(l)}
            }, htmlBuilder: r1, mathmlBuilder: r4
        });
        var r6 = (e, t) => {
            ...
            var r = e.font, a = t.withFont(r);
            return tP(e.body, a)
        }, r3 = {"\\Bbb": "\\mathbb", "\\bold": "\\mathbf", "\\frak": "\\mathfrak", "\\bm": "\\boldsymbol"};
        tp({
            type: "font",
            ...
            handler(e, t) {
                var {parser: r, funcName: a} = e, n = td(t[0]), i = a;
                return i in r3 && (i = r3[i]), {type: "font", mode: r.mode, font: i.slice(1), body: n}
            },
            htmlBuilder: r6,
            mathmlBuilder: r7
        }), tp({
            type: "mclass", names: ["\\boldsymbol", "\\bm"], props: {numArgs: 1}, handler(e, t) {
                var {parser: r} = e, a = t[0], n = f.isCharacterBox(a);
                return {
                    type: "mclass",
                    mode: r.mode,
                    mclass: r5(a),
            ...
            props: {numArgs: 0, allowedInText: !0},
            handler(e, t) {
                var {parser: r, funcName: a, breakOnTokenText: n} = e, {mode: i} = r, s = r.parseExpression(!0, n);
                return {
                    type: "font",
                    mode: i,
                    font: "math" + a.slice(1),
        ...
        var r8 = (e, t) => {
            ...
            var r, a, n, i, s, o, l, h, m, c, p, u = r8(e.size, t.style), d = u.fracNum(), g = u.fracDen();
            r = t.havingStyle(d);
            var f = tT(e.numer, r, t);
            if (e.continued) {
                var v = 8.5 / t.fontMetrics().ptPerEm, b = 3.5 / t.fontMetrics().ptPerEm;
            ...
            if (e.hasBarLine ? (e.barSize ? (n = $(e.barSize, t), a = ta.makeLineSpan("frac-line", t, n)) : a = ta.makeLineSpan("frac-line", t), n = a.height, i = a.height) : (a = null, n = 0, i = t.fontMetrics().defaultRuleThickness), u.size === B.DISPLAY.size || "display" === e.size ? (s = t.fontMetrics().num1, o = n > 0 ? 3 * i : 7 * i, l = t.fontMetrics().denom1) : (n > 0 ? (s = t.fontMetrics().num2, o = i) : (s = t.fontMetrics().num3, o = 3 * i), l = t.fontMetrics().denom2), a) {
                ...
                h = ta.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: y, shift: l}, {type: "elem", elem: a, shift: w}, {
                        type: "elem",
                        elem: f,
                        shift: -s
                    }]
                ...
                k < o && (s += .5 * (o - k), l += .5 * (o - k)), h = ta.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: y, shift: l}, {type: "elem", elem: f, shift: -s}]
                }, t)
            }
        ...
        var ae = ["display", "text", "script", "scriptscript"], at = function (e) {
            var t = null;
        ...
        tp({
            ...
            handler(e, t) {
                var r, {parser: a} = e, n = t[4], i = t[5], s = td(t[0]),
                    o = "atom" === s.type && "open" === s.family ? at(s.text) : null, l = td(t[1]),
                    h = "atom" === l.type && "close" === l.family ? at(l.text) : null, m = tK(t[2], "size"), c = null;
            ...
            handler(e, t) {
                var {parser: r, funcName: a} = e, n = t[0], i = d(tK(t[1], "infix").size), s = t[2], o = i.number > 0;
                return {
                    type: "genfrac",
                    mode: r.mode,
                    numer: n,
        ...
        var ar = (e, t) => {
            ...
            var s = tT(a.base, t.havingBaseStyle(B.DISPLAY)), o = tZ.svgSpan(a, t);
        ...
        tp({
            ...
            }, htmlBuilder: ar, mathmlBuilder(e, t) {
            ...
            handler(e, t) {
                var {parser: r} = e, a = t[1], n = tK(t[0], "url").url;
            ...
            handler(e, t) {
                var {parser: r} = e, a = tK(t[0], "url").url;
                ...
                return {type: "href", mode: r.mode, href: a, body: tg(o)}
            }
        }), tp({
            type: "hbox",
            names: ["\\hbox"],
            ...
            handler(e, t) {
                var {parser: r} = e;
                return {type: "hbox", mode: r.mode, body: tg(t[0])}
            },
            htmlBuilder(e, t) {
                var r = tw(e.body, t, !1);
                return ta.makeFragment(r)
            ...
            handler(e, t) {
                var r, {parser: a, funcName: n, token: s} = e, o = tK(t[0], "raw").string, l = t[1];
            ...
            htmlBuilder(e, t) {
                var r = tw(e.body, t, !1), a = ["enclosing"];
            ...
            type: "htmlmathml", names: ["\\html@mathml"], props: {numArgs: 2, allowedInText: !0}, handler(e, t) {
                var {parser: r} = e;
                return {type: "htmlmathml", mode: r.mode, html: tg(t[0]), mathml: tg(t[1])}
            }, htmlBuilder(e, t) {
                var r = tw(e.html, t, !1);
                return ta.makeFragment(r)
        ...
        tp({
            ...
            handler(e, t, r) {
                var {parser: a} = e, n = {number: 0, unit: "em"}, s = {number: .9, unit: "em"},
                    o = {number: 0, unit: "em"}, l = "";
                if (r[0]) for (var h = tK(r[0], "raw").string.split(","), m = 0; m < h.length; m++) {
                    var c = h[m].split("=");
                    if (2 === c.length) {
                        var p = c[1].trim();
                        switch (c[0].trim()) {
            ...
            handler(e, t) {
                var {parser: r, funcName: a} = e, n = tK(t[0], "size");
                if (r.settings.strict) {
                    var i = "m" === a[1], s = "mu" === n.value.unit;
            ...
            htmlBuilder(e, t) {
                ...
                var r, a = ta.makeSpan(["fix"], []), n = ta.makeSpan([e.alignment], [r, a], t),
                    i = ta.makeSpan(["strut"]);
            ...
            handler(e, t) {
                ...
                a.switchMode("math");
                var i = "\\(" === r ? "\\)" : "$", s = a.parseExpression(!1, i);
                return a.expect(i), a.switchMode(n), {type: "styling", mode: a.mode, style: "text", body: s}
            }
        }), tp({
            type: "text",
            names: ["\\)", "\\]"],
        ...
        var ai = (e, t, r, a, n, i, s) => {
            ...
            if (t) {
                ...
                l = {elem: c, kern: Math.max(a.fontMetrics().bigOpSpacing1, a.fontMetrics().bigOpSpacing3 - c.depth)}
            }
            if (r) {
                var p = tT(r, a.havingStyle(n.sub()), a);
                o = {elem: p, kern: Math.max(a.fontMetrics().bigOpSpacing2, a.fontMetrics().bigOpSpacing4 - p.height)}
            }
            if (l && o) {
                ...
                h = ta.makeVList({
                    positionType: "bottom",
                    positionData: u,
                    children: [{type: "kern", size: a.fontMetrics().bigOpSpacing5}, {
                        type: "elem",
                        elem: o.elem,
                        marginLeft: Z(-i)
                    }, {type: "kern", size: o.kern}, {type: "elem", elem: e}, {
                        type: "kern",
                        size: l.kern
                    }, {type: "elem", elem: l.elem, marginLeft: Z(i)}, {
                        type: "kern",
                ...
                h = ta.makeVList({
                    positionType: "bottom",
                    positionData: g,
                    children: [{type: "elem", elem: e}, {type: "kern", size: l.kern}, {
                        type: "elem",
                        elem: l.elem,
                        marginLeft: Z(i)
            ...
            if (o.size === B.DISPLAY.size && n.symbol && !f.contains(as, n.name) && (l = !0), n.symbol) {
                ...
                if (("\\oiint" === n.name || "\\oiiint" === n.name) && (m = n.name.substr(1), n.name = "oiint" === m ? "\\iint" : "\\iiint"), i = ta.makeSymbol(n.name, h, "math", t, ["mop", "op-symbol", l ? "large-op" : "small-op"]), m.length > 0) {
                    var c = i.italic, p = ta.staticSvg(m + "Size" + (l ? "2" : "1"), t);
                    i = ta.makeVList({
                        positionType: "individualShift",
                        children: [{type: "elem", elem: i, shift: 0}, {type: "elem", elem: p, shift: l ? .08 : 0}]
            ...
            var r;
            if (e.symbol) r = new tN("mo", [tO(e.name, e.mode)]), f.contains(as, e.name) && r.setAttribute("largeop", "false"); else if (e.body) r = new tN("mo", tL(e.body, t)); else {
        ...
        tp({
            ...
            type: "op", names: ["\\mathop"], props: {numArgs: 1, primitive: !0}, handler(e, t) {
                ...
                return {type: "op", mode: r.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: tg(a)}
            }, htmlBuilder: ao, mathmlBuilder: al
        });
        var am = {"∫": "\\int", "∬": "\\iint", "∭": "\\iiint", "∮": "\\oint", "∯": "\\oiint", "∰": "\\oiiint"};
        tp({
            type: "op",
        ...
        var ac, ap, au = (e, t) => {
            ...
            for (var r = tL(e.body, t.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
                var i = r[n];
                if (i instanceof tR.SpaceNode) ; else if (i instanceof tR.MathNode) switch (i.type) {
                    case"mi":
                    case"mn":
                    case"ms":
                    case"mspace":
        ...
        tp({
            ...
            type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler(e, t) {
                ...
                var r = tT(e.body, t.havingCrampedStyle()), a = ta.makeLineSpan("overline-line", t),
                    n = t.fontMetrics().defaultRuleThickness, i = ta.makeVList({
                        positionType: "firstBaseline",
                        children: [{type: "elem", elem: r}, {type: "kern", size: 3 * n}, {
                            type: "elem",
                            elem: a
                        }, {type: "kern", size: n}]
                    }, t);
            ...
            type: "phantom", names: ["\\phantom"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                var {parser: r} = e, a = t[0];
                return {type: "phantom", mode: r.mode, body: tg(a)}
            }, htmlBuilder(e, t) {
            ...
            type: "hphantom", names: ["\\hphantom"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                ...
                var r = tL(tg(e.body), t), a = new tR.MathNode("mphantom", r), n = new tR.MathNode("mpadded", [a]);
            ...
            type: "vphantom", names: ["\\vphantom"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                ...
                var r = ta.makeSpan(["inner"], [tT(e.body, t.withPhantom())]), a = ta.makeSpan(["fix"], []);
            ...
            handler(e, t) {
                var {parser: r} = e, a = tK(t[0], "size").value, n = t[1];
                return {type: "raisebox", mode: r.mode, dy: a, body: n}
            },
            htmlBuilder(e, t) {
                var r = tT(e.body, t), a = $(e.dy, t);
                return ta.makeVList({positionType: "shift", positionData: -a, children: [{type: "elem", elem: r}]}, t)
            },
            mathmlBuilder(e, t) {
                var r = new tR.MathNode("mpadded", [tP(e.body, t)]), a = e.dy.number + e.dy.unit;
                return r.setAttribute("voffset", a), r
            }
        }), tp({
            type: "internal", names: ["\\relax"], props: {numArgs: 0, allowedInText: !0}, handler(e) {
                var {parser: t} = e;
            ...
            handler(e, t, r) {
                var {parser: a} = e, n = r[0], i = tK(t[0], "size"), s = tK(t[1], "size");
                return {type: "rule", mode: a.mode, shift: n && tK(n, "size").value, width: i.value, height: s.value}
            },
            htmlBuilder(e, t) {
                var r = ta.makeSpan(["mord", "rule"], [], t), a = $(e.width, t), n = $(e.height, t),
            ...
            mathmlBuilder(e, t) {
                var r = $(e.width, t), a = $(e.height, t), n = e.shift ? $(e.shift, t) : 0,
                    i = t.color && t.getColor() || "black", s = new tR.MathNode("mspace");
        ...
        tp({
            type: "sizing", names: af, props: {numArgs: 0, allowedInText: !0}, handler(e, t) {
                var {breakOnTokenText: r, funcName: a, parser: n} = e, i = n.parseExpression(!1, r);
                return {type: "sizing", mode: n.mode, size: af.indexOf(a) + 1, body: i}
            }, htmlBuilder: av, mathmlBuilder(e, t) {
                var r = t.havingSize(e.size), a = tL(e.body, r), n = new tR.MathNode("mstyle", a);
            ...
            handler(e, t, r) {
                var {parser: a} = e, n = !1, i = !1, s = r[0] && tK(r[0], "ordgroup");
                if (s) for (var o = "", l = 0; l < s.body.length; ++l) if ("t" === (o = s.body[l].text)) n = !0; else if ("b" === o) i = !0; else {
                    n = !1, i = !1;
                    break
                } else n = !0, i = !0;
                var h = t[0];
            ...
            htmlBuilder(e, t) {
                ...
                var i = ta.makeVList({positionType: "firstBaseline", children: [{type: "elem", elem: r}]}, t);
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler(e, t, r) {
                ...
                var p = ta.makeVList({
                    ...
                    children: [{type: "elem", elem: r, wrapperClasses: ["svg-align"]}, {
                        type: "kern",
                        size: -(r.height + c)
                    }, {type: "elem", elem: o}, {type: "kern", size: l}]
                }, t);
                if (!e.index) return ta.makeSpan(["mord", "sqrt"], [p], t);
                var u = t.havingStyle(B.SCRIPTSCRIPT), d = tT(e.index, u, t), g = .6 * (p.height - p.depth),
                    f = ta.makeVList({positionType: "shift", positionData: -g, children: [{type: "elem", elem: d}]}, t),
        ...
        var ab = {display: B.DISPLAY, text: B.TEXT, script: B.SCRIPT, scriptscript: B.SCRIPTSCRIPT};
        tp({
            type: "styling",
            names: ["\\displaystyle", "\\textstyle", "\\scriptstyle", "\\scriptscriptstyle"],
            props: {numArgs: 0, allowedInText: !0, primitive: !0},
            handler(e, t) {
                var {breakOnTokenText: r, funcName: a, parser: n} = e, i = n.parseExpression(!0, r),
                    s = a.slice(1, a.length - 5);
                return {type: "styling", mode: n.mode, style: s, body: i}
            },
            htmlBuilder(e, t) {
                var r = ab[e.style], a = t.havingStyle(r).withFont("");
                return ag(e.body, a, t)
            },
            mathmlBuilder(e, t) {
                var r = ab[e.style], a = t.havingStyle(r), n = tL(e.body, a), i = new tR.MathNode("mstyle", n), s = {
                    display: ["0", "true"],
                    text: ["0", "false"],
                    script: ["1", "false"],
        ...
        tu({
            type: "supsub", htmlBuilder(e, t) {
                ...
                if (s) return s(e, t);
                var {base: o, sup: l, sub: h} = e, m = tT(o, t), c = t.fontMetrics(), p = 0, u = 0,
                    d = o && f.isCharacterBox(o);
                if (l) {
                ...
                var b = t.sizeMultiplier, y = Z(.5 / c.ptPerEm / b), x = null;
                if (a) {
                ...
                if (r && a) {
                    ...
                    var M = [{type: "elem", elem: a, shift: u, marginRight: y, marginLeft: x}, {
                        type: "elem",
                        elem: r,
                        shift: -p,
                        marginRight: y
                    }];
                    i = ta.makeVList({positionType: "individualShift", children: M}, t)
                } else if (a) {
                    u = Math.max(u, c.sub1, a.height - .8 * c.xHeight);
                    var z = [{type: "elem", elem: a, marginLeft: x, marginRight: y}];
                    i = ta.makeVList({positionType: "shift", positionData: u, children: z}, t)
                } else if (r) p = Math.max(p, n, r.depth + .25 * c.xHeight), i = ta.makeVList({
                    positionType: "shift",
                    positionData: -p,
                    children: [{type: "elem", elem: r, marginRight: y}]
                }, t); else throw Error("supsub must have either sup or sub.");
                ...
                var s = [tP(e.base, t)];
                if (e.sub && s.push(tP(e.sub, t)), e.sup && s.push(tP(e.sup, t)), i) n = r ? "mover" : "munder"; else if (e.sub) {
                    if (e.sup) {
                        var o = e.base;
        ...
        var ax = {mi: "italic", mn: "normal", mtext: "normal"};
        tu({
            type: "mathord", htmlBuilder: (e, t) => ta.makeOrd(e, t, "mathord"), mathmlBuilder(e, t) {
                var r = new tR.MathNode("mi", [tO(e.text, e.mode, t)]), a = tE(e, t) || "italic";
                return a !== ax[r.type] && r.setAttribute("mathvariant", a), r
            }
        }), tu({
            type: "textord", htmlBuilder: (e, t) => ta.makeOrd(e, t, "textord"), mathmlBuilder(e, t) {
                var r, a = tO(e.text, e.mode, t), n = tE(e, t) || "normal";
        ...
        var aw = {"\\nobreak": "nobreak", "\\allowbreak": "allowbreak"}, ak = {
            " ": {},
            "\\ ": {},
            "~": {className: "nobreak"},
            "\\space": {},
        ...
        tu({
            type: "spacing", htmlBuilder(e, t) {
                ...
                var r;
                if (ak.hasOwnProperty(e.text)) r = new tR.MathNode("mtext", [new tR.TextNode("\xa0")]); else if (aw.hasOwnProperty(e.text)) return new tR.MathNode("mspace"); else throw new i('Unknown type of space "' + e.text + '"');
                return r
            }
        });
        var aS = () => {
        ...
        var aM = {
                ...
                "\\texttt": "texttt",
                "\\textnormal": "textrm"
            }, az = {"\\textbf": "textbf", "\\textmd": "textmd"}, aA = {"\\textit": "textit", "\\textup": "textup"},
            aT = (e, t) => {
                var r = e.font;
        ...
        tp({
            ...
            handler(e, t) {
                var {parser: r, funcName: a} = e, n = t[0];
                return {type: "text", mode: r.mode, body: tg(n), font: a}
            },
            htmlBuilder(e, t) {
                var r = aT(e, t), a = tw(e.body, r, !0);
            ...
            type: "underline", names: ["\\underline"], props: {numArgs: 1, allowedInText: !0}, handler(e, t) {
                ...
                var r = tT(e.body, t), a = ta.makeLineSpan("underline-line", t),
                    n = t.fontMetrics().defaultRuleThickness, i = ta.makeVList({
                        positionType: "top",
                        positionData: r.height,
                        children: [{type: "kern", size: n}, {type: "elem", elem: a}, {
                            type: "kern",
                            size: 3 * n
                        }, {type: "elem", elem: r}]
                    }, t);
            ...
            htmlBuilder(e, t) {
                var r = tT(e.body, t), a = t.fontMetrics().axisHeight, n = .5 * (r.height - a - (r.depth + a));
                return ta.makeVList({positionType: "shift", positionData: n, children: [{type: "elem", elem: r}]}, t)
            },
            ...
            type: "verb", names: ["\\verb"], props: {numArgs: 0, allowedInText: !0}, handler(e, t, r) {
                ...
                var r = new tR.TextNode(aB(e)), a = new tR.MathNode("mtext", [r]);
                return a.setAttribute("mathvariant", "monospace"), a
            }
        });
        var aB = e => e.body.replace(/ /g, e.star ? "␣" : "\xa0"), aq = "[ \r\n	]", aC = "[̀-ͯ]",
            aN = RegExp(aC + "+$"),
        ...
        aZ = function (e) {
            ...
            if ("'" === a.text) t = 8, a = e.popToken(); else if ('"' === a.text) t = 16, a = e.popToken(); else if ("`" === a.text) {
                if ("\\" === (a = e.popToken()).text[0]) n = a.text.charCodeAt(1); else if ("EOF" === a.text) throw new i("\\char` missing argument"); else n = a.text.charCodeAt(0)
            } else t = 10;
            if (t) {
        ...
        var aJ, aQ, a0, a1, a4, a5, a6, a7, a3, a8, a2, a9, ne, nt, nr, na, nn, ni, ns, no, nl, nh, nm, nc, np, nu, nd,
            ng, nf, nv, nb, ny, nx, nw, nk, nS, nM, nz, nA, nT, nB, nq, nC, nN, nI, nR, nO, nH, nE, nL, nD, nP, nF, nV,
            nG, nU, nY, nX, nW, n_, nj, n$, nZ, nK, nJ, nQ, n0, n1, n4, n5, n6, n7, n3, n8, n2, n9, ie, it, ir, ia, ii,
            is, io, il, ih, im, ic, ip, iu, id, ig, iv, ib, iy, ix, iw, ik, iS, iM, iz, iA, iT, iB, iq, iC, iN, iI, iR,
            iO, iH, iE, iL, iD, iP, iF, iV, iG, iU, iY = (e, t, r) => {
                var a = e.consumeArg().tokens;
                if (1 !== a.length) throw new i("\\newcommand's first argument must be a macro name");
                var n = a[0].text, s = e.isDefined(n);
        ...
        var ij, i$, iZ, iK, iJ, iQ, i0, i1, i4, i5, i6, i7, i3, i8, i2, i9, se, st, sr, sa, sn, si, ss, so, sl, sh, sm,
            sc, sp, su, sd, sg, sf, sv, sb, sy, sx, sw, sk, sS, sM, sz, sA, sT, sB, sq, sC, sN, sI, sR, sO, sH, sE, sL,
            sD, sP, sF, sV, sG, sU, sY, sX, sW, s_ = {
                ")": !0,
                "]": !0,
                "\\rbrack": !0,
                "\\}": !0,
        ...
        var sj, s$, sZ, sK, sJ, sQ, s0, s1, s4, s5, s6, s7, s3, s8, s2, s9, oe, ot, or, oa, on, oi, os, oo, ol, oh, om,
            oc, op, ou, od, og, of, ov, ob, oy, ox, ow, ok, oS, oM, oz, oA, oT, oB, oq, oC, oN, oI, oR, oO, oH, oE, oL,
            oD, oP, oF, oV, oG, oU, oY, oX, oW, o_, oj, o$, oZ, oK, oJ, oQ, o0, o1, o4, o5, o6, o7, o3, o8, o2, o9, le,
            lt, lr, la, ln, li, ls, lo, ll, lh, lm, lc, lp, lu, ld, lg, lf, lv, lb, ly, lx, lw, lk, lS, lM, lz, lA, lT,
            lB, lq, lC, lN, lI, lR, lO, lH, lE, lL, lD, lP, lF, lV, lG, lU, lY, lX, lW, l_, lj, l$, lZ, lK, lJ, lQ, l0,
            l1, l4, l5, l6, l7, l3, l8, l2, l9, he, ht, hr, ha, hn, hi, hs, ho, hl, hh, hm, hc, hp, hu, hd, hg, hf, hv,
            hb, hy, hx, hw, hk, hS, hM, hz, hA, hT, hB, hq, hC, hN, hI, hR, hO, hH, hE, hL, hD, hP, hF, hV, hG, hU, hY,
            hX, hW, h_, hj, h$, hZ, hK, hJ, hQ, h0, h1, h4, h5, h6, h7, h3, h8, h2, h9, me, mt, mr, ma, mn, mi, ms, mo,
            ml, mh, mm, mc, mp, mu, md, mg, mf, mv, mb, my, mx, mw, mk, mS, mM, mz, mA, mT, mB, mq, mC, mN, mI, mR, mO,
            mH, mE, mL, mD, mP, mF, mV, mG, mU, mY, mX, mW, m_, mj, m$, mZ, mK, mJ, mQ, m0, m1, m4, m5, m6, m7, m3, m8,
            m2, m9, ce = Z(E["Main-Regular"][84][1] - .7 * E["Main-Regular"][65][1]);
        ...
        var ct, cr, ca, cn, ci, cs, co, cl, ch, cm, cc, cp, cu, cd, cg, cf, cv, cb, cy, cx, cw, ck, cS, cM, cz, cA, cT,
            cB, cq, cC, cN, cI, cR, cO, cH, cE, cL, cD, cP, cF, cV, cG, cU, cY, cX, cW, c_, cj, c$, cZ, cK, cJ, cQ, c0,
            c1, c4, c5, c6, c7, c3, c8, c2, c9, pe, pt, pr, pa, pn, pi, ps, po, pl, ph, pm, pc, pp, pu, pd, pg, pf, pv,
            pb, py, px, pw, pk, pS, pM, pz, pA, pT, pB, pq, pC, pN, pI, pR, pO, pH, pE, pL, pD, pP, pF, pV, pG, pU, pY,
            pX, pW, p_, pj, p$, pZ, pK, pJ, pQ, p0, p1, p4, p5, p6, p7, p3, p8 = e => t => {
                var r = t.consumeArg().tokens, a = t.consumeArg().tokens, n = t.consumeArg().tokens,
                    i = t.consumeArg().tokens, s = t.macros.get("|"), o = t.macros.get("\\|");
                t.macros.beginGroup();
                var l = t => r => {
        ...
        class p9 {
            ...
            consumeSpaces() {
                for (; ;) if (" " === this.future().text) this.stack.pop(); else break
            }

            consumeArg(e) {
                var t, r = [], a = e && e.length > 0;
                a || this.consumeSpaces();
                var n = this.future(), s = 0, o = 0;
                do {
                    if (t = this.popToken(), r.push(t), "{" === t.text) ++s; else if ("}" === t.text) {
            ...
            expandOnce(e) {
                ...
                var n = a.tokens, s = this.consumeArgs(a.numArgs, a.delimiters);
                if (a.numArgs) {
                    n = n.slice();
                    for (var o = n.length - 1; o >= 0; --o) {
                        ...
                        if ("#" === l.text) {
                            ...
                            if ("#" === (l = n[--o]).text) n.splice(o + 1, 1); else if (/^[1-9]$/.test(l.text)) n.splice(o, 2, ...s[+l.text - 1]); else throw new i("Not a valid argument number", l)
                        }
                    }
                }
            ...
            _getExpansion(e) {
                ...
                if ("string" == typeof a) {
                    ...
                    for (var s = new aR(a, this.settings), o = [], l = s.lex(); "EOF" !== l.text;) o.push(l), l = s.lex();
        ...
        var ue = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, ut = Object.freeze({
            "₊": "+",
            "₋": "-",
            "₌": "=",
            "₍": "(",
        ...
        class un {
            ...
            handleInfixNodes(e) {
                for (var t = -1, r = 0; r < e.length; r++) if ("infix" === e[r].type) {
                    if (-1 !== t) throw new i("only one infix operator per group", e[r].token);
                    t = r, a = e[r].replaceWith
                }
                if (-1 === t || !a) return e;
                var a, n, s, o, l = e.slice(0, t), h = e.slice(t + 1);
            ...
            parseAtom(e) {
                ...
                for (; ;) {
                    ...
                    if ("\\limits" === n.text || "\\nolimits" === n.text) {
                        ...
                        } else if (a && "operatorname" === a.type) a.alwaysHandleSupSub && (a.limits = "\\limits" === n.text); else throw new i("Limit controls must follow a math operator", n);
                        this.consume()
                    } else if ("^" === n.text) {
                        ...
                        var h = ut[n.text], m = ue.test(n.text);
                        for (this.consume(); ;) {
                        ...
                        m ? r = {type: "ordgroup", mode: "math", body: p} : t = {
                            type: "ordgroup",
                            mode: "math",
                            body: p
                        }
            ...
            parseFunction(e, t) {
                var r = this.fetch(), a = r.text, n = th[a];
                if (!n) return null;
            ...
            callFunction(e, t, r, a, n) {
                var s = th[e];
                if (s && s.handler) return s.handler({funcName: e, parser: this, token: a, breakOnTokenText: n}, t, r);
            ...
            parseArguments(e, t) {
                ...
                for (var a = [], n = [], s = 0; s < r; s++) {
                    ...
                    if (l) n.push(h); else if (null != h) a.push(h); else throw new i("Null argument, please report this as a bug")
                }
            ...
            parseSymbol() {
                ...
                if (s && ("i" === (t = t.substring(0, s.index)) ? t = "ı" : "j" === t && (t = "ȷ")), ep[this.mode][t]) {
                    ...
                    var o, l, h = ep[this.mode][t].group, m = a.range(e);
                    o = em.hasOwnProperty(h) ? {type: "atom", mode: this.mode, family: h, loc: m, text: t} : {
                        type: h,
                        mode: this.mode,
                        loc: m,
                        text: t
                ...
                if (this.consume(), s) for (var c = 0; c < s[0].length; c++) {
                    var p = s[0][c];
        ...
        var uo = function (e, t) {
            ...
            __defineSymbol: eu,
            __defineMacro: rF,
            __domTree: {Span: et, Anchor: er, SymbolNode: ei, SvgNode: es, PathNode: eo, LineNode: el}
        }
    }
}]);